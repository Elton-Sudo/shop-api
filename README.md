...
- **Prisma** – Modern ORM for database interactions with MySQL.
- **MySQL** – Relational database used for storing application data.
- **Docker** – Containerization for managing dependencies and environments.
- **JWT (jsonwebtoken)** – Secure authentication and role-based access control.
- **Bcrypt.js** – Password hashing for enhanced security.
- **ESLint & Prettier** – Enforces coding standards and formatting.
- **Jest & Supertest** – Testing framework for unit and integration testing.
- **Morgan** – HTTP request logging middleware for debugging and monitoring.
